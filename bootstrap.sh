...
git_install djangoogle andreps@git.andreanjos.org:git/djangoogle
git_install audit andreps@git.andreanjos.org:git/audit
git_install nav andreps@git.andreanjos.org:git/nav
git_install djpro andreps@git.andreanjos.org:git/djpro
